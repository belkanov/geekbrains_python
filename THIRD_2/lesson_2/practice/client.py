...
class Client(metaclass=ClientMaker):
    ...
    def __init__(self, args):
        self.srv_addr = args.a
        self.srv_port = args.p
        self.username = args.u

    def process_srv_msg(self, message: dict):
    ...
    def processing_output(self, server_socket, client_name):
        while True:
            try:
                srv_msg = self.process_srv_msg(get_message(server_socket))
                if srv_msg:
                    print(srv_msg)
